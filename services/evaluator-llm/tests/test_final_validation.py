...
import pytest
from evaluator_llm.providers.event_evaluation import EventEvaluationProvider
from evaluator_llm.types import UnifiedEvaluationRequest, EvaluationConfig, EvaluationType
...
def test_migration_patterns():
    ...
    from evaluator_llm.helpers.integration_guide import MIGRATION_PATTERNS
