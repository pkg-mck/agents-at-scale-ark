...
Before installing ark-controller, ensure you have the following:

- **Docker**: Container runtime for building the controller image
- **Kubernetes cluster**: A running Kubernetes cluster (e.g. kind, minikube, Orbstack, Docker Desktop)
- **Helm 3.x**: Package manager for Kubernetes applications
- **kubectl**: Command-line tool for interacting with Kubernetes
- **Go** programming language (for cli)
