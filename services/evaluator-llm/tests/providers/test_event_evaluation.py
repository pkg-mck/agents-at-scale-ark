...
class TestEventEvaluationProvider:
    ...
    def setup_method(self):
        ...
        with patch('src.evaluator_llm.providers.event_evaluation.config') as mock_config:
    ...
    @patch('src.evaluator_llm.providers.event_evaluation.config')
    @patch('src.evaluator_llm.providers.event_evaluation.client')
    ...
    @patch('src.evaluator_llm.providers.event_evaluation.EventAnalyzer')
    @patch('src.evaluator_llm.providers.event_evaluation.ToolHelper')
    @patch('src.evaluator_llm.providers.event_evaluation.AgentHelper')
    @patch('src.evaluator_llm.providers.event_evaluation.TeamHelper')
    @patch('src.evaluator_llm.providers.event_evaluation.LLMHelper')
    @patch('src.evaluator_llm.providers.event_evaluation.SequenceHelper')
    @patch('src.evaluator_llm.providers.event_evaluation.QueryHelper')
