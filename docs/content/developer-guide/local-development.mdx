...
Each service contains their own devspace config. You can either start the entire project by doing
```bash
devspace dev
```


If you wish to start individual services and wish to use localhost gateway routes, you must first start it
