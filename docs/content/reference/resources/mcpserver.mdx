...
See the [samples/mcp](../../samples/mcp) directory for additional examples including:
...
**Next**: Learn about [Tools](/advanced-features/tools) for creating custom agent capabilities.