...
### Common Issues with 'ark install' local setup
---
#### 1. Access Denied When Installing `agents-at-scale`
...
---
#### 2. `ark-api-a2a` Not Installed Automatically During `ark install`
...
---
#### 3. Webhook Call Fails on Kind Cluster (Works Fine on Minikube)
