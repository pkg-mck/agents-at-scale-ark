...
if [ ! -f services/ark-api/ark-api/wheels/ark_sdk-*.whl ]; then
    echo "Building ARK SDK wheel..."
    make ark-sdk-build
    mkdir -p services/ark-api/ark-api/wheels
    cp out/ark-sdk/py-sdk/dist/ark_sdk-*.whl services/ark-api/ark-api/wheels/
