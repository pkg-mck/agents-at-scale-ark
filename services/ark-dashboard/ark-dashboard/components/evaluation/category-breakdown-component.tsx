...
import { CategoryBreakdown } from "@/lib/services/evaluations"
...
export function CategoryBreakdownComponent({ 
  ...
  const failedCategories = categories.filter(cat => cat.passed === false).length
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-green-600">{passedCategories}</p>
            <p className="text-sm text-muted-foreground">Passed</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-red-600">{failedCategories}</p>
        ...
        {totalWeight > 1 && (
          <div className="bg-muted/50 p-4 rounded-lg">
            <h4 className="font-medium mb-2">Weighted Score Summary</h4>
            ...
            <div className="mt-2">
              <Progress value={(weightedScore / totalWeight) * 100} className="h-2" />
            </div>
          </div>
        )}
      </CardContent>
