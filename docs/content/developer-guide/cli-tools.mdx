...
ARK provides two command-line tools for different use cases. For basic Kubernetes operations, see [Kubernetes Integration](/concepts/kubernetes).
...
### [k9s](#k9s) - Terminal-based Kubernetes UI
...
**Next**: Learn about [Compatible Models](/concepts/models) and AI provider integration.
